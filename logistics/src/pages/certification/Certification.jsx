...
const CargoCertification = lazy(() => import('./subPage/CargoCertification/CargoCertification.jsx'));
const CarCertification = lazy(() => import('./subPage/CarCertification/CarCertification.jsx'));
const ConsignmentCertification = lazy(() => import('./subPage/ConsignmentCertification/ConsignmentCertification.jsx'));
const DriverCertification = lazy(() => import('./subPage/DriverCertification/DriverCertification.jsx'));
const ShipmentCertification = lazy(() => import('./subPage/ShipmentCertification/ShipmentCertification.jsx'));
