...
import { postFinanceAccounts, getOrganizations, fundsRecharge } from '@/services/apiService';
import GetSmsCode from '@/pages/Registered/GetSmsCode';
import Copy from './CopyText';
import styles from './ReplaceRecharge.less';
                ...
                >
                  {
                    options.map(item => (
                      <Option value={item.organizationId}>
                        ...
                        {item.organizationType === 4 && '-托运'}
                        {item.organizationType === 5 && '-承运'}
                      </Option>))
                  }
                </Select>
              )}
