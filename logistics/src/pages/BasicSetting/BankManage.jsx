...
import styles from './BankManage.less'
  ...
  render () {
    ...
    return (
      <>
        <div styleName='title'>
          <span>对公账户信息</span>
          {/* <Authorized authority={[BANK_SETTING_CREATE]}>
            <Button type='primary' bankaccounttype='1' size='small' onClick={this.showModal}>新增</Button>
          </Authorized> */}
        </div>
        ...
        <div styleName='title'>
          <span>备付金账户信息</span>
          {/* <Authorized authority={[BANK_SETTING_CREATE]}>
            <Button type='primary' bankaccounttype='2' size='small' onClick={this.showModal}>新增</Button>
          </Authorized> */}
        </div>
