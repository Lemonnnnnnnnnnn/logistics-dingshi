...
import { notification, Tabs, Row, Spin, Modal, Col, Button } from 'antd';
...
import UserRemoteSelect from '@/components/Common/SelectAsync';
import { debounce } from '@/utils/utils';
import moment from 'moment';
import { getProjectDetail, setTransportMsgApi, getTransport } from '@/services/apiService';
...
export default class ModifyModal extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({ cars: [{ carNo: plateNumber, carId: data.carId }] });
    // 运单详情
