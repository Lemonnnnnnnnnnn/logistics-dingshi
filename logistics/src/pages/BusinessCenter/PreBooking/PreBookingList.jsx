...
import ORGANIZATION_TYPE from '../../../constants/organization/organizationType';
import DeliveryField from './component/DeliveryField';
import DispatchField from './component/DispatchField';
import '@gem-mine/antd-schema-form/lib/fields';
import styles from './PreBookingList.css';
        ...
        const detail = {
          ...
          onClick: (record) => {
            ...
            this.organizationType === ORGANIZATION_TYPE.SHIPMENT
              ? router.push(`preBooking/dispatch?${paramsStr}&mode=${FORM_MODE.DETAIL}`) // 调度
...
class DispatchBox extends Component {
  ...
  handleDispatch = (value) => {
    ...
    router.push(`preBooking/dispatch?prebookingId=${record.prebookingId}&mode=${FORM_MODE.ADD}`);
  }
