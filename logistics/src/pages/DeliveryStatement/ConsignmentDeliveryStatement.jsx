...
import ConsignmentDeliverStatementList from '@/pages/DeliveryStatement/subPage/ConsignmentDeliverStatementList';
import ConsignmentDeliverStatementDetailedList
  from '@/pages/DeliveryStatement/subPage/ConsignmentDeliverStatementDetailedList';
