...
import RenderSearchInput from './SearchForm';
...
class MyTable extends Component {
  ...
  static getDerivedStateFromProps (props, state) {
    ...
    if (props.pagination?.pageSize && props.pagination.pageSize !== state.pageSize){
      state.pageSize = props.pagination.pageSize;
    }
  ...
  // 翻页记不住选项
  // onChangeKeys = (_, rows) => {
  //   this.setState({ keys: rows.map(row => row[this.props.rowKey]) });
  // }
    ...
    return (
      <div ref={this.saveRef}>
        <div styleName="table-operatorBar">
          ...
          : <RenderSearchInput searchObj={searchObj} searchList={searchList} buttonList={buttonList} pagination={pagination} />}
        </div>
        {TabTitle && (
          <div>
            {TabTitle}
