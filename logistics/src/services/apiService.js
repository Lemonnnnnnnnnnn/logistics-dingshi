...
export const getProject = params => request.get('/v1/projects/simple', { params });

export const getUser = params => request.get('/v1/users', {
  params: {
    ...params,
    organizationId: JSON.parse(localStorage.getItem('token_storage')).organizationId,
  },
});
...
export const getCar = (params) => request.get('/v1/cars', { params });
...
// 业务往来导出支付凭证
export const exportFinanceBusinessPayOrderPdf = params => request.get('/v1/financeBusiness/payOrderPdf', { params });

// 招投标首页提示
export const getTenderBidderNotify = () => request.get('/v1/tenderBidder/notify');

/**
 * @description 行驶证副业（末页）OCR
 */
export const vehicleLicenseLastOcr = (params) => request.get('/v1/cars/drivingLicenseValidityDateOcr', { params });

// 导出司机列表
export const exportDriversExcel = params => request.get('/v1/drivers/excel', { params });

// 简易项目列表
export const getProjectsSimple = params => request.get('/v1/projects/simple', { params });

// 读取自动调度信息Excel
export const getProjectAutomaticReadExcel = params => request.get('/v1/projectAutomatic/readExcel', { params });

// 依据车牌号集合，获取GPS设备
export const getCarDevice = params => request.get('/v1/serviceCar/carBrandList', { params });

// 获取项目所属货品
export const getProjectGoods = projectId => request.get(`/v1/goods/projectId/${projectId}`, { params: projectId });

// 获取有设备的车辆列表
export const getServiceCars = (params) => request.get(`/v1/serviceCar/carNoAndSoidList`, { params });
