...
import { PLATFORM, OWNER as CONSIGNMENT, SHIPMENT } from '@/constants/organization/organizationType';
...
export const getNeedPay = (record) =>{
  const { serviceCharge, damageCompensation, accountInternalStatus } = record;
