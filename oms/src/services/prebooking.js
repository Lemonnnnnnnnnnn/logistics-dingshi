...
// 计算预约单计划重量
const countPrebookingPlanWeight = deliveryItems => classifyGoodsWeight(deliveryItems, 'goodsId', ['goodsId', 'goodsName', 'categoryName', 'goodsUnitCN', 'receivingNum'], (summary, current) => summary.receivingNum += current.receivingNum)
