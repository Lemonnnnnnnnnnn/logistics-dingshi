...
import { Table, Popconfirm, Checkbox, Select } from 'antd';
import CSSModules from 'react-css-modules';
import { isArray, isFunction, xorBy } from '../../utils/utils';
import Authorized from '../../utils/Authorized';
import NormalizeSchema from '../table/normalize';
import styles from './select-all-page-table.less';
