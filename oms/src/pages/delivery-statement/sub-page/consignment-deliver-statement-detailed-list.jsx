...
import { getAllProjectsList, getSupplierOrganizationNameList } from '../../../services/apiService';
...
export default class ConsignmentDeliverStatementDetailedList extends Component {
  ...
  handleResetBtnClick = () => {
    ...
    delete(oldFilter.accountOutboundNo);
    delete(oldFilter.projectId);
    delete(oldFilter.transportNo);
    delete(oldFilter.supplierOrganizationName);
    delete(oldFilter.checkStatusList);
    delete(oldFilter.accountOutboundId);
    delete(oldFilter.supplierOrganizationId);
    delete(oldFilter.deliveryTime);
    delete(oldFilter.deliveryEndTime);
    delete(oldFilter.deliveryStartTime);
    delete(oldFilter.supplierOutboundEndTime);
    delete(oldFilter.supplierOutboundStartTime);
    delete(oldFilter.supplierOutboundTime);
