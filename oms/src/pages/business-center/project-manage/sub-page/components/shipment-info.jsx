...
export default class ShipmentInfo extends Component {
  ...
  render () {
    ...
    return (
      <EditableTable minWidth={1500} isAbleToDelete={this.isAbleToDelete} customOperations={this.customOperations} readOnly={readOnly} onChange={onChange} rowKey="shipmentOrganizationId" pagination={false} columns={columns} dataSource={value} />
    );
  }
}
