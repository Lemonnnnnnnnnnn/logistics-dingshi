...
import RenderSearchInput from '@/components/table/search-form';
import { getLocal, isEmpty } from "@/utils/utils";
import styles from './template-select.less';
      ...
      <div className={styles.generalContent}>
        <div className={styles.generalContentItem}>
          ...
          <div className={styles.generalContentItemBtn}>
            <span onClick={() => history.push("/buiness-center/project/projectManagement/createProject")}> 选择模板</span>
          </div>
        </div>
      </div>
    </div>
