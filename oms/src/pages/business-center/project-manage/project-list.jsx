...
import { pick, translatePageType , getGoodsName } from '../../../utils/utils';
...
import ShipmentInfo from './sub-page/components/shipment-info';
  ...
  tableSchema = {
    ...
    operations: (record) => {
      ...
      const shipmentAccept = {
        title: '接受',
        // onClick: (record) => { this.showAuthModal(1, record.projectId); },
