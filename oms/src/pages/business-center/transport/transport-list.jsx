...
import ExcelOutput from '../../../components/excel-output/excel-output';
import TransportVerify from './component/transport-verify';
import ModifyTransportReject from './component/modify-transport-reject';
import ModifyModal from './component/modify-modal';
import styles from './transport.less';
import CancelTransportModal from "./component/cancel-transport-modal";
import ExportPdf from "@/components/Export/ExportPdf";
import ExportInvoicePic from '@/components/Export/ExportInvoicePic';
import { ORGANIZATION_TEXT, OWNER as CONSIGNMENT } from '@/constants/organization/organization-type';
      ...
      columns: [
        ...
        },
        {
          ...
          render: (text, record) => {
            ...
            if (this.viewSupplementPermission && record.replenishmentStatus) replenishmentStatus =
              <span style={{
                display: 'block',
