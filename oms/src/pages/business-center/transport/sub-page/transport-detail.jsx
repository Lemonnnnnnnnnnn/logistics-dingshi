...
import DeliveryInfo from '../component/delivery-info';
import TransportEvent from '../component/transport-event';
import AccountEvent from '../component/account-event';
...
function SkipTo (props) {
  ...
  const pathArr = [];
  let pushTo;
  const { organizationType } = JSON.parse(localStorage.getItem('token'));
