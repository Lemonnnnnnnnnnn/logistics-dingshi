...
const PrograssBar = ({ yesterdayAdd, todayAdd })=>{
  ...
  return (
    <div style={{ position: 'relative', backgroundColor: 'rgba(240, 242, 245, 1)', height:'14px', width:'100%' }}>
      <div style={{ position: 'absolute', backgroundColor: 'rgba(250, 211, 55, 1)', height:'14px', top:'0px', left: '50%', width: yesterdayBarWidth }} />
      <div style={{ position: 'absolute', backgroundColor: 'rgba(78, 203, 116, 1)', height:'14px', top:'0px', left: todayBarLeft, width: todayBarWidth }} />
    </div>
  );
};
