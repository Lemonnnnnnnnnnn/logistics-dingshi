...
import { CONSIGNMENT_OBJ } from '../../../../constants/organization/organization-type';
...
export default ({ location }) => {
  ...
  return <OrganizationManage organizationsId={organizationsId} mode={mode} organization={CONSIGNMENT_OBJ} />;
};
