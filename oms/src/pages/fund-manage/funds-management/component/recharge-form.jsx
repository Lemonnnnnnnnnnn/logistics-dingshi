...
import BigPriceInput from './big-price-input';
        ...
        {formStep === true?
          <div styleName='from_box'>
            <SchemaForm schema={this.rechargeForm}>
              ...
              <div styleName='getRechargeCode_confirm_btn'>
                <DebounceFormButton size='large' loading={btnLoading} label="确认并获取汇款识别码" type="primary" onClick={this.getRechargeCode} />
              </div>
            </SchemaForm>
            <h3>注意：</h3>
