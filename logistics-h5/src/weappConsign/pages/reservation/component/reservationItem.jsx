...
import styles from './reservationItem.less'
...
export default class ReservationItem extends Component{
  ...
  renderList = () => {
    const { item:{ deliveryItems, receivingItems } } = this.props
  ...
  toDetail = () => {
    ...
    router.push(`/WeappConsign/reservation/detail?prebookingId=${this.props.item.prebookingId}&type=${type}`)
  }
